...
The game opens on a **title screen** (Continue / New Game / How to Play / Options). First-timers get a **guided tour** that auto-runs on day 1 and walks through the buy panel top-to-bottom; it's replayable any time from the **❓ help button**, and a static **How to Play** reference with a glossary is reachable from the title screen and the pause menu.
...
- **Spoilage:** Leftover perishables degrade overnight when it's warm — milk spoils above ~24°C, ice melts above ~4°C, and faster the hotter it gets. Don't over-stock ahead of a hot day; stable ingredients (beans, cups, syrup) keep indefinitely.
...
- **Start Day** to open the shop. Pedestrians walk by; some stop, look, and react with thought bubbles. Watch the **Hype meter** rise/fall. Adjust the cup price mid-day if it's too high or too low. Tap the weather or hype chip to expand it for a deeper read on the day.
